...
- Instead of using one large computer to store and process the data, Hadoop allows [clustering multiple computers to analyze massive datasets](../../HLD-System-Designs/4_Scalability/ServersCluster.md) in parallel more quickly.
...
| [Apache HDFS](../../HLD-System-Designs/9_FileStorages/ApacheHDFS.md)               | Distributed file storage                                             |
...
- To run a job to query the data, provide a [MapReduce job](../DataProcessing/ApacheMapReduce/Readme.md) made up of many map and reduce tasks that run against the data in [HDFS](../../HLD-System-Designs/9_FileStorages/ApacheHDFS.md) spread across the DataNodes.
